            ...
            <div className="allProjects">
                ...
                <div>
                    <div className="camping">
                        <a href="https://dispersed-camping.herokuapp.com/" target="_blank" rel="noopener noreferrer">
                    ...
                    <div className="github">
                        <a href="https://github.com/hrocco25/camping" target="_blank" rel="noopener noreferrer"><h4>Check out my code on Github</h4></a>
                    </div>
                </div>

                <div>
                    <div className="brewery">
                        <a href="https://heatherbreweryapp2.herokuapp.com/" target="_blank" rel="noopener noreferrer">
                    ...
                    <div className="github">
                        <a href="https://github.com/hrocco25/brewery" target="_blank" rel="noopener noreferrer"><h4>Check out my code on Github</h4></a>
                    </div>
                </div>
                
                <div>
                    <div className="greatReads">
                        <a href="https://greatreads.netlify.com/" target="_blank" rel="noopener noreferrer">
                    ...
                    <div className="github">
                        <a href="https://github.com/viviRbi/Great-reads" target="_blank" rel="noopener noreferrer"><h4>Check out my code on Github</h4></a>
                    </div>
                </div>
                ...
                <div>
                    <div className="trivia">
                        <a href="https://hrocco25.github.io/seir-project-one/" target="_blank" rel="noopener noreferrer">
